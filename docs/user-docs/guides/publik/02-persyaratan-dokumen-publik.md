# Akses Publik Persyaratan Dokumen - Panduan Pengguna

> **Kelompok Pengguna:** Publik / Tamu
> **Urutan:** 2 dari 3 — Lihat persyaratan sebelum mendaftar akun.
...
Halaman publik **hanya menampilkan informasi**. Untuk mengajukan surat:

1. Di kotak ajakan **Daftar/Login untuk Mengajukan**, pilih:
   - **Daftar** — jika belum punya akun warga
...
**Q: Apakah saya harus login untuk melihat persyaratan?**
A: Tidak. Siapa saja dapat melihat daftar dan detail persyaratan tanpa akun.

**Q: Jenis surat yang sudah diarsip admin apakah muncul?**
A: Tidak. Hanya jenis surat yang masih aktif yang ditampilkan.
