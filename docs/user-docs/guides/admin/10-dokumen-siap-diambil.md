...
Setelah surat PDF dibuat (status **Diproses**), petugas desa menetapkan **tanggal pengambilan** sesuai jam kerja kantor lewat menu **Surat Diproses**. Status berubah menjadi **Siap Diambil**, dan warga mendapat notifikasi kapan datang mengambil surat.

> Panduan lengkap menu: [Surat Diproses & Siap Diambil](08-surat-diproses.md).

## Cara Menggunakan

### Menandai Dokumen Siap Diambil
...
### Menyelesaikan Pengambilan (Scan QR)

Setelah status **Siap Diambil**, scan QR pada surat saat warga datang. Panduan: [Scan QR Pengambilan](10-qr-sekali-pakai.md).
