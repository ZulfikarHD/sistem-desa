# Validasi Kelengkapan Pengajuan - Panduan Pengguna
...
A: Tidak, jika jenis surat yang dipilih mewajibkan dokumen tersebut. Kolom unggah yang tampil menandakan dokumen wajib.
...
A: Tidak. Sistem hanya menyimpan pengajuan setelah semua validasi lulus, termasuk dokumen wajib.
...
| Error format/ukuran file | Lihat [panduan unggah dokumen](pengajuan-surat-dokumen.md). |
