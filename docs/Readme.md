...
| [Verifikasi Pengajuan (US-4.1 & US-4.2)](dev-docs/features/verifikasi-pengajuan.md) | Admin list + detail preview dokumen KTP/KK |
...
| [Panduan Verifikasi Pengajuan](user-docs/guides/verifikasi-pengajuan.md) | Cara admin memeriksa pengajuan dan pratinjau dokumen |
