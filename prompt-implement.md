    # Task: Implement [US-7.1] From Scrum Plan "@scrum-planning/Phase 07 - Penerbitan Surat Keterangan.md " , Test, and Document
    ...
    2. Find the section for **[Phase 06]**. Quote or restate its full scope/requirements in your own words before continuing — including acceptance criteria, edge cases, and any explicitly out-of-scope items mentioned in the plan.
    ...
    1. **[Phase 06] Plan Summary** (must include an "Open Scope Questions" subsection per Compliance Rule 7 — write "None found" if genuinely none)
