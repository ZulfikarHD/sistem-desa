    # Task: Implement [US-ID] From Scrum Plan "PLAN-ID" , Test, and Document
    ...
    2. Find the section for **[US-ID]**. Quote or restate its full scope/requirements in your own words before continuing — including acceptance criteria, edge cases, and any explicitly out-of-scope items mentioned in the plan.
    ...
    1. **[US-ID] Plan Summary** (must include an "Open Scope Questions" subsection per Compliance Rule 7 — write "None found" if genuinely none)
