...
US-8.2 H1 answers “status surat”; “Dashboard Warga” is a small label only. Hero includes progress track via WargaDashboard::langkahAlur / indeksLangkahAktif. Riwayat is a linked list (not admin table). Keep data-test selectors used by e2e/dashboard.spec.ts.
