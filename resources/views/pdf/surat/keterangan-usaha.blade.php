...
@section('body')
    ...
    <p class="penutup">
        Orang tersebut di atas benar memiliki / menjalankan usaha di wilayah {{ $desa['nama_desa'] }}
        sesuai keterangan keperluan di atas. Surat ini dibuat untuk dipergunakan sebagaimana mestinya.
    </p>
@endsection
